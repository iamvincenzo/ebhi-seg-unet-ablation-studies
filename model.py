##########################################################################################
# Model similar to arc_change_net: more readable and you can configure skip-connections #
#########################################################################################
...
class UNet(nn.Module):
    ...
    def __init__(self, args):
        ...
        if self.args.no_skeep_7:
            self.up_conv_1 = self.conv_layer(512, 512)
        else:
        ...
        if self.args.no_skeep_5:
            self.up_conv_2 = self.conv_layer(256, 256)
        else:
        ...
        if self.args.no_skeep_3:
            self.up_conv_3 = self.conv_layer(128, 128)
        else:
        ...
        if self.args.no_skeep_1:        
            self.up_conv_4 = self.conv_layer(64, 64)
        else:
